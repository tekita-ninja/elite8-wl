...
<template>
  ...
  bulletActiveClass: 'swipper-pagination-bullet-active',
      ...
      <SwiperSlide
        ...
        v-for="slide in controller.banners" :key="slide.id">
        <img class="h-full w-full object-cover" :src="toLinkAsset(slide.filename)" alt="image">
        <!-- <img class="h-full w-full object-cover" src="/images/1.png" alt="image"> -->
      </SwiperSlide>
    </Swiper>
  </div>
</template>
