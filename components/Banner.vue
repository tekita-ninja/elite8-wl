...
<template>
    <div
        ...
        class="mt-4 max-w-[221px] md:max-w-sm mx-auto overflow-hidden aspect-auto backdrop-blur rounded-xl shadow shadow-[#CBAA61] bg-gradient-to-tr from-[#CBAA61]/20 via-slate-950/90 to-[#CBAA61]/50 text-slate-100"
    >
        <Swiper
            class="h-full w-full"
            :speed="1000"
